...
import citizenworkspace.renderer.eligibilityresults.helper.MyItemsTooltipHelper;
...
/**
 * Renderer class for rendering the My Items Tooltip Dialog.
 */
public class MyItemsTooltipDialogRenderer extends AbstractViewRenderer {
  ...
  public void render(final Field field,
    ...
    final RendererHelper<Node> helper = new MyItemsTooltipHelper();
