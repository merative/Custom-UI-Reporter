...
import citizenworkspace.renderer.eligibilityresults.helper.CategoryActionsHelper;
...
/**
 * Renderer for Category Actions.
 */
public class CategoryActionsRenderer extends AbstractViewRenderer {
  ...
  public void render(final Field field,
    ...
    final RendererHelper<Node> helper = new CategoryActionsHelper();
