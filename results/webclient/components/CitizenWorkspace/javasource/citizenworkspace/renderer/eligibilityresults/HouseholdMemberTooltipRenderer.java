...
import citizenworkspace.renderer.eligibilityresults.helper.HouseholdMemberTooltipHelper;
...
/**
 * Renderer class for rendering the Household Member Tooltip.
 */
public class HouseholdMemberTooltipRenderer extends AbstractViewRenderer {
  ...
  public void render(final Field field,
    ...
    final RendererHelper<Node> helper = new HouseholdMemberTooltipHelper();
