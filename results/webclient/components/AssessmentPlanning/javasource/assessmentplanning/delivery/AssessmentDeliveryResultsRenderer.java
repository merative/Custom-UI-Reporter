...
/**
 * Renderer for displaying the assessment delivery results.
 * 
 * @since 6.0
 */
public class AssessmentDeliveryResultsRenderer extends AbstractViewRenderer {

  /**
   * The path to the graph SWF.
   */
  private static final String kFLEX_GRAPH_SWF = "../flex/Graph.swf";

  /**
   * The height to be used for the ratings chart.
   */
  private static final String kCHART_HEIGHT = "350";
  ...
  public void render(final Field field,
    ...
    // CDR (SBN) - Consider adding this as a parameter instead
    param.setAttribute("value", kFLEX_GRAPH_SWF);
    ...
    // CDR (SBN) - Consider adding this as a parameter instead
    embed.setAttribute("src", kFLEX_GRAPH_SWF);
